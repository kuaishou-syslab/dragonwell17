...
void InterpreterMacroAssembler::jump_from_interpreted(Register method, Register temp) {
  ...
  if (JvmtiExport::can_post_interpreter_events()) {
    ...
    if (EnableCoroutine) {
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), vmIntrinsics::as_int(vmIntrinsics::_switchTo));
      jcc(Assembler::zero, coroutine_skip_interpret);
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), vmIntrinsics::as_int(vmIntrinsics::_switchToAndExit));
      jcc(Assembler::zero, coroutine_skip_interpret);
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), vmIntrinsics::as_int(vmIntrinsics::_switchToAndTerminate));
      jcc(Assembler::zero, coroutine_skip_interpret);
    }
...
void InterpreterMacroAssembler::remove_activation(
 ...
 // get method access flags
  ...
  if (StackReservedPages > 0) {
    ...
    cmpl(Address(rthread, JavaThread::stack_guard_state_offset()), static_cast<int32_t>(StackGuardState::stack_guard_enabled));
