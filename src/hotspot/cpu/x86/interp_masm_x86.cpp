...
void InterpreterMacroAssembler::jump_from_interpreted(Register method, Register temp) {
  ...
  if (JvmtiExport::can_post_interpreter_events()) {
    ...
    if (EnableCoroutine) {
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), (int)vmIntrinsics::_switchTo);
      jcc(Assembler::zero, coroutine_skip_interpret);
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), (int)vmIntrinsics::_switchToAndExit);
      jcc(Assembler::zero, coroutine_skip_interpret);
      cmpw(Address(method, Method::intrinsic_id_offset_in_bytes()), (int)vmIntrinsics::_switchToAndTerminate);
      jcc(Assembler::zero, coroutine_skip_interpret);
    }
