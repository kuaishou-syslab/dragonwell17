...
class JavaThread: public Thread {
 ...
 public:
  ...
  static ByteSize stack_overflow_limit_offset()      {
    return byte_offset_of(JavaThread, _stack_overflow_state._stack_info.stack_overflow_limit);
  }
  static ByteSize stack_guard_state_offset()         {
    return byte_offset_of(JavaThread, _stack_overflow_state._stack_info.stack_guard_state);
  }
  static ByteSize reserved_stack_activation_offset() {
    return byte_offset_of(JavaThread, _stack_overflow_state._stack_info.reserved_stack_activation);
  }
  static ByteSize stack_base_offset()                {
    return byte_offset_of(JavaThread, _stack_overflow_state._stack_info.stack_base);
  }
  static ByteSize stack_end_offset()                 {
    return byte_offset_of(JavaThread, _stack_overflow_state._stack_info.stack_end);
  }
