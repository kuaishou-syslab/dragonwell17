...
class VirtualSpace {
 ...
 public:
  // Initialization
  VirtualSpace();
  bool initialize_with_granularity(ReservedSpace rs, size_t committed_byte_size, size_t max_commit_ganularity, bool coroutine_stack = false);
  bool initialize(ReservedSpace rs, size_t committed_byte_size, bool coroutine_stack = false);
  ...
  bool expand_by(size_t bytes, bool pre_touch = false, bool coroutine_stack = false);
